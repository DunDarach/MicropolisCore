...
// include: /var/folders/s2/sq61w78j4357cmwrvdrqdtxr0000gn/T/tmpt2hsjgog.js
  ...
  (() => {
    ...
    function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build/micropolisengine.data';
      var REMOTE_PACKAGE_BASE = 'micropolisengine.data';
...
Module['FS_createPath']("/", "cities", true, true);
      ...
      Module['addRunDependency']('datafile_build/micropolisengine.data');
...
// end include: /var/folders/s2/sq61w78j4357cmwrvdrqdtxr0000gn/T/tmpt2hsjgog.js
// include: /var/folders/s2/sq61w78j4357cmwrvdrqdtxr0000gn/T/tmpdna68tuc.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if (Module['$ww'] || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/s2/sq61w78j4357cmwrvdrqdtxr0000gn/T/tmpdna68tuc.js
// include: /var/folders/s2/sq61w78j4357cmwrvdrqdtxr0000gn/T/tmpf_01lb48.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/s2/sq61w78j4357cmwrvdrqdtxr0000gn/T/tmpf_01lb48.js
...
function findWasmBinary() {
  if (Module['locateFile']) {
    return locateFile('micropolisengine.wasm');
  }
  // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
  return new URL('micropolisengine.wasm', import.meta.url).href;
}
