...
import { MicropolisSimulator } from './MicropolisSimulator';
import { TileRenderer } from './TileRenderer';
import { WebGPUMapRenderer } from './WebGPUMapRenderer';
...
class WebGPUTileRenderer extends TileRenderer<GPUCanvasContext> {
    ...
    public mapRenderer: WebGPUMapRenderer;
    ...
    constructor() {
       ...
       this.mapRenderer = {} as WebGPUMapRenderer;
    ...
    setupSubRenderers( micropolisSimulator: MicropolisSimulator) {
        this.mapRenderer = new WebGPUMapRenderer();
        this.mapRenderer.initialize(micropolisSimulator, this.device);
    ...
    render(): void {
       ...
       this.device.queue.writeTexture( {texture:this.mapTexture}, this.mapData, {bytesPerRow:100 * Uint16Array.BYTES_PER_ELEMENT}, { width: 100, height:120 });
        ...
        this.mapRenderer.encodeRenderPass(commandEncoder, textureView, this.verticeBuffer);
...
export { TileRenderer, WebGPUTileRenderer,verticesDescription };